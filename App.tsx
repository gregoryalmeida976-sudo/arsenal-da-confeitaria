        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex flex-col gap-12 items-center justify-center max-w-2xl mx-auto">
            ...
            <div className="text-center py-4 flex flex-col items-center gap-4">
               ...
               <p className="text-amber-400 font-black text-xl md:text-2xl uppercase italic tracking-tighter drop-shadow-md animate-bounce">
                  Mas calma aí... abaixo temos uma oferta melhor ainda! 👇
               </p>
               <div className="h-px w-24 bg-slate-700"></div>
            </div>

            {/* Main Offer Card (Highlighted) - NOW SECOND */}
            <div className="bg-white rounded-3xl shadow-[0_0_60px_-15px_rgba(255,255,255,0.3)] overflow-hidden w-full relative border-4 border-amber-400 flex flex-col transform hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="p-8 text-center bg-rose-50/50 pb-6">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                   {['Slice Cake', 'Copo Felicidade', 'Taças Gourmet', 'Brigadeiros'].map((tag) => (
              ...
              <div className="p-6 md:p-10 flex-1 flex flex-col">
                ...
                <div className="space-y-4 mb-8 flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    <div className="bg-green-50 p-4 rounded-xl border border-green-100 flex flex-col items-center text-center gap-2 shadow-sm">
                      <Play className="w-8 h-8 text-green-600" />
                      <span className="text-xs font-bold text-slate-700 leading-tight uppercase">Portal de Vídeos <br/>Passo a Passo</span>
                    </div>
                    <div className="bg-green-50 p-4 rounded-xl border border-green-100 flex flex-col items-center text-center gap-2 shadow-sm">
                      <Calculator className="w-8 h-8 text-green-600" />
                      <span className="text-xs font-bold text-slate-700 leading-tight uppercase">Calculadora <br/>de Lucro Real</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 pt-4">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3">
                        ...
                        <span className="text-slate-700 text-base font-semibold text-left">
                          {feat}
                        </span>
                      </div>
                    ))}
